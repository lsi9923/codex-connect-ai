...
const LOCAL_PROFILE = '/connect-ai/assets/agents/';
...
export const AGENTS: Record<AgentId, AgentDef> = {
  ceo: {
    ...
    profileImage: `${LOCAL_PROFILE}ceo_profile.png`,
    desk: { x: 50, y: 50 },
    defaultModel: 'hermes/gpt-5.5',
  ...
  youtube: {
    ...
    profileImage: `${LOCAL_PROFILE}youtube_profile.png`,
  ...
  instagram: {
    ...
    profileImage: `${LOCAL_PROFILE}instagram_profile.png`,
    desk: { x: 34, y: 16 },
    defaultModel: 'hermes/gpt-5.5',
  ...
  designer: {
    ...
    profileImage: `${LOCAL_PROFILE}designer_profile.png`,
    desk: { x: 66, y: 16 },
    defaultModel: 'hermes/gpt-5.5',
  ...
  developer: {
    ...
    profileImage: `${LOCAL_PROFILE}developer_profile.png`,
  ...
  business: {
    ...
    profileImage: `${LOCAL_PROFILE}business_profile.png`,
    desk: { x: 14, y: 72 },
    defaultModel: 'hermes/gpt-5.5',
  ...
  secretary: {
    ...
    profileImage: `${LOCAL_PROFILE}secretary_profile.png`,
  ...
  editor: {
    ...
    profileImage: `${LOCAL_PROFILE}editor_profile.png`,
  ...
  writer: {
    ...
    profileImage: `${LOCAL_PROFILE}writer_profile.png`,
    desk: { x: 68, y: 82 },
    defaultModel: 'hermes/gpt-5.5',
  ...
  researcher: {
    ...
    profileImage: `${LOCAL_PROFILE}researcher_profile.png`,
    desk: { x: 86, y: 72 },
    defaultModel: 'hermes/gpt-5.5',
